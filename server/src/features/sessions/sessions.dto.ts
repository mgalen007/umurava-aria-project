...
export const createSessionDto = z.object({
  ...
  modelUsed:    z.enum(['gemini-1.5-flash', 'gemini-1.5-pro']).default('gemini-1.5-flash'),
});
...
export const feedbackDto = z.object({
  ...
  { message: 'Adjusted score is required when action is overridden', path: ['adjustedScore'] }
);
